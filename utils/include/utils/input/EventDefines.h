 ...
 * */
typedef enum {
  UNKNOWN_TYPE = 0, //SDL_FIRSTEVENT,

  /* Keyboard events */
  KEYBOARD_PRESS_TYPE = 768, //SDL_KEYDOWN,        /* Key pressed */
  KEYBOARD_RELEASE_TYPE = 769, //SDL_KEYUP,        /* Key released */
  OS_TEXTEDITING_TYPE = 770, //SDL_TEXTEDITING,    /* Keyboard text editing */

  /* Mouse events */
  MOUSE_MOTION_TYPE = 1024, //SDL_MOUSEMOTION,      /* Mouse moved */
  MOUSE_PRESS_TYPE = 1025, //SDL_MOUSEBUTTONDOWN,   /* Mouse button pressed */
  MOUSE_RELEASE_TYPE = 1026, //SDL_MOUSEBUTTONUP,   /* Mouse button released */
  MOUSE_WHEEL_MOTION_TYPE = 1027, //SDL_MOUSEWHEEL, /* Mouse wheel motion */

  /* Touch events */
  FINGER_PRESS_TYPE = 1792, //SDL_FINGERDOWN,       /* Finger pressed */
  FINGER_RELEASE_TYPE = 1793, //SDL_FINGERUP,       /* Finger released */
  FINGER_MOTION_TYPE = 1794, //SDL_FINGERMOTION,    /* Finger moved */

  /* Gesture events */
  DOLLAR_GESTURE_TYPE = 2048, //SDL_DOLLARGESTURE,
  DOLLAR_RECORD_TYPE = 2049, //SDL_DOLLARRECORD,
  MULTI_GESTUGE_TYPE = 2050, //SDL_MULTIGESTURE,

  QUIT_TYPE = 256, //SDL_QUIT                 /* User requests quit */
  WINDOW_TYPE = 512, //SDL_WINDOWEVENT        /* Window state change */
  TEXT_INPUT_TYPE = 771, //SDL_TEXTINPUT      /* Keyboard text input */
  OS_LANGUAGE_CHANGED_TYPE = 772, //SDL_KEYMAPCHANGED

  AUDIO_DEVICE_ADDED_TYPE = 4352 //SDL_AUDIODEVICEADDED
} EventDataTypes;
...
typedef enum {
  MOUSE_UNKNOWN = 0,
  MOUSE_LEFT_BUTTON = 1, //SDL_BUTTON_LEFT
  MOUSE_MIDDLE_BUTTON = 2, //SDL_BUTTON_MIDDLE
  MOUSE_RIGHT_BUTTON = 3 //SDL_BUTTON_RIGHT
} MouseKey;

typedef enum {
  TOUCH_EVENT_UNKNOWN = 0,
  TOUCH_PRESS,
  TOUCH_RELEASE,
  KEYBOARD_PRESS,
  KEYBOARD_RELEASE,
